...
\subsection{Research Budgets after WWII}
...
\begin{frame}[t]%
 \titleframe{Overlay Journals}\vskip1cm%
...
\begin{frame}[t]{JTCAM: Challenges}
  ...
  \item 24 articles published
    ...
    \end{itemize}
  \item Strong influence of journal metrics
    \begin{itemize}
...
\begin{frame}[t]
 \titleframe{JTCAM: Motivation \& Chronology}\vskip1cm
