...
\begin{frame}[t]%
 \titleframe{Overlay Journal}\vskip1cm%
...
\begin{frame}[t]{JTCAM}{Journal of Theoretical, Computational and Applied Mechanics}
\vspace{.5cm}
  \textbf{Features}
  \begin{itemize}
  \item Diamond Open Access
  \item Overlay
  \item Peer-Reviewed (Single-Blind or Open Reviews)
  \item FAIR open access (\textbf{F}indable, \textbf{A}ccessible, \textbf{I}nteroperable, \textbf{R}eusable)
  \item \href{https://jtcam.episciences.org/}{EPIsciences}: Open-Source CMS
  \end{itemize}

  \vfill
  \textbf{Organization\&Boards}
  \begin{itemize}
  \item Editorial Board (volonteers)
  \item Scientific Advisory Board (volonteers)
  \item Technical Board (volonteers)
  \end{itemize}
...
\vfill
  \textbf{A}ccessible
  \begin{itemize}
  \item OpenSource \href{https://www.episciences.org/}{Episcience} CMS (funded by French \href{https://www.ccsd.cnrs.fr/}{CCSD} through CNRS, INRIA, INRAE)  
...
\begin{frame}[t]%
 \titleframe{JTCAM: publication process}\vskip1cm%
 \begin{center}%
